...
const Navbar = ({ setToggle }) => {
  ...
  return (
    <>
      <div
        id="navbar"
        className="flex shadow-md h-22 p-3 items-center justify-between"
      >
        <div id="menu-bar yt-icon" className="flex items-center gap-x-4">
          {/* Menu-Bar-Btn */}
          <div
            id="menubarBtn"
            className="hover:bg-lightgray rounded-full p-2"
        ...
        {/* search-btn-for-input  */}
        <div
          id="searchBar"
          className="flex justify-between ml-[5rem] items-center w-[52vw] "
        >
          <div className="flex">
            {/* input-btn */}
            <div className="relative">
              <input
                ...
                className="w-[42vw] h-[2.5rem]  border border-gray border-r-0 rounded-r-none rounded-3xl p-1 pl-5 focus:outline-none"
              />
              {/* X-btn */}
              {inputValue && (
                <button
            ...
            <button
              id="searchBtn"
              className=" rounded-3xl rounded-l-none border border-gray h-[2.5rem] w-[5vw] flex justify-center items-center"
            >
              <svg
                viewBox="0 0 24 24"
                preserveAspectRatio="xMidYMid meet"
        ...
        <div>
          <svg
            ...
            preserveAspectRatio="xMidYMid meet"
            focusable="false"
            className="style-scope yt-icon h-7 ml-32"
          >
        ...
        <div
          id="user-icon"
          className=" mr-[2rem] hover:bg-lightblue  px-3 py-2  text-blue  flex gap-x-1 items-center  rounded-3xl "
        >
          <svg
            xmlns="http://www.w3.org/2000/svg"
