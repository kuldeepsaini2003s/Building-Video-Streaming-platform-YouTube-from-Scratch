...
const Navbar = ({ setToggle }) => {
  ...
  const getInputBorderColor = () => {
    return theme === "dark" ? "lightblack" : "gray";
  };
  ...
  return (
    <>
      ...
      <div
        ...
        }  flex fixed -z-50 h-20 p-3 items-center w-full justify-between`}
      >
          {/* Menu-Bar-Btn */}
        ...
        >
          <div className="flex">
            ...
            <div className="relative">
              <input
                ...
                className={`bg-${theme === "dark" ? "black" : "white"} text-${
                  theme === "dark" ? "white" : "black"
                } w-[42vw] h-[2.5rem]   border border-${getInputBorderColor()} border-r-0 rounded-r-none rounded-3xl p-1 pl-5 focus:outline-none`}
              />
              {/* X-btn */}
              {inputValue && (
                <button
            ...
            <button
              id="searchBtn"
              className={`rounded-3xl rounded-l-none border border-${getInputBorderColor()} bg-${getIconsBgColor()} h-[2.5rem] w-[5vw] flex justify-center items-center`}
            >
              <svg
                viewBox="0 0 24 24"
                preserveAspectRatio="xMidYMid meet"
          ...
          <div>
            ...
            <button
              id="audioBtn"
              className={`bg-${getIconsBgColor()} rounded-full p-2 `}
            >
              <svg
                viewBox="0 0 24 24"
                preserveAspectRatio="xMidYMid meet"
      ...
      {showSetting && (
        <div
          className={`bg-${theme === "dark" ? "black" : "white"}  text-${
            theme === "dark" ? "white" : "black"
          } fixed  right-40 top-[4rem] shadow-lg rounded-xl py-5`}   
        >
          ...
          <div>
            <p
              ...
              className={`text-sm hover:bg-${getHoverBgColor()} w-[99.9%]  p-2 pl-10 w-max cursor-pointer`}
            >
              Dark Theme
            </p>
            <p
