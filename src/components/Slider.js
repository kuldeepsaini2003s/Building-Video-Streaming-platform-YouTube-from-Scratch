...
const Slider = () => {
  ...
  const handleToggle = () => {
    ...
    // document.querySelector("#slider-bar").classList.add("active");
  };  

  return (
    <div
      className={`slider w-[100vw] fixed z-20 h-[100vh] bg-black bg-opacity-40 top-0 ${
        isSliderOpen ? "active" : ""
      }`}
    ...
    >
      <div
        id="slider-bar"
        className={` floting h-[100vh] dark:bg-black bg-white z-50 px-3 py-2  shadow-xl w-[14rem] transition duration-700 ease-in-out          `}
      ...
      >
        <div id="menu-bar yt-icon" className="flex items-center ml-1 gap-x-4">
          ...
          <div
            id="menubar-Btn"
            className="rounded-full p-2 hover:bg-lightgray dark:hover:bg-icon_black"
            onClick={handleToggle}
          >
