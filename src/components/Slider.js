...
const Slider = ({ setToggle }) => {
  ...
  const getInputBorderColor = () => {
    return theme === "dark" ? "Lightgray" : "gray";
  };
  const getIconsBgColor = () => {
    return theme === "dark" ? "Lightgray" : "lightgray";
  };
  ...
  return (
    <div className="w-[100vw] fixed h-[100vh] bg-black bg-opacity-40 top-0">
      <div
        id="slider-bar"
        className={`slider bg-${theme === "dark" ? "black" : "white"} text-${
          theme === "dark" ? "white" : "black"
        }  h-[100vh] z-50 p-3 shadow-xl w-[14rem]`} 
      >
        <div id="menu-bar yt-icon" className="flex items-center gap-x-4">
          {/* Menu-Bar-Btn */}
          <div
            id="menubar-Btn"
            className={`hover:bg-${getHoverBgColor()} rounded-full p-2`}
        ...
        <div id="sideMenu" className="flex flex-col items-center py-5 px-0 ">
          ...
          <div
            ...
            className={`active w-full flex  items-center px-3  hover:bg-${getHoverBgColor()} rounded-xl h-10`}
          >
            <svg
              viewBox="0 0 24 24"
              preserveAspectRatio="xMidYMid meet"
            ...
            >
              <g>
                <path fill={getSvgColor()} d="M4,10V21h6V15h4v6h6V10L12,3Z"></path>
              </g>
            </svg>
          ...
          >
            ...
            >
              <g>
                <path fill={getSvgColor()} d="M10,18v-6l5,3L10,18z M17,3H7v1h10V3z M20,6H4v1h16V6z M22,9H2v12h20V9z M3,10h18v10H3V10z"></path>
              </g>
            </svg>
          ...
          <div className="border-t border-gray  mt-3 py-2 w-full">
            <div className={`active w-full flex  items-center px-3  hover:bg-${getHoverBgColor()} rounded-xl h-10`}>
              <p>You</p>
              <svg
            ...
            >
              ...
              >
                ...
                <path fill={getSvgColor()} d="M9 10a3 3 0 1 0 6 0a3 3 0 0 0 -6 0" />
                <path fill={getSvgColor()} d="M6 21v-1a4 4 0 0 1 4 -4h4a4 4 0 0 1 4 4v1" />
            ...
            >
              ...
              >
                <g>
                  <path fill={getSvgColor()} d="M11,7l6,3.5L11,14V7L11,7z M18,20H4V6H3v15h15V20z M21,18H6V3h15V18z M7,17h13V4H7V17z"></path>
                </g>
              </svg>
          ...
          >
            ...
            >
              <path stroke="none" d="M0 0h24v24H0z" fill="none" />
              <path fill={getSvgColor()} d="M12 12m-9 0a9 9 0 1 0 18 0a9 9 0 1 0 -18 0" />
              <path fill={getSvgColor()} d="M12 12l3 2" />
              <path fill={getSvgColor()} d="M12 7v5" />
            </svg>
